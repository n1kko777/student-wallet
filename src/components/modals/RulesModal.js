...
const RulesModal = ({ visible, handleOk, handleCancel }) => {
  ...
  return (
    ...
    >
      ...
      <Paragraph>
        ...
        меры по обеспечению безопасности персональных данных в РГППУ (далее –
      ...
      <Paragraph>
        ...
        <ul>
          ...
          <li>
            ...
            необходима для уточнения персональных данных); • информационная
          ...
          <li>
            ...
            данных; • обработка персональных данных - любое действие (операция)
      ...
      <Paragraph>
        Компания обязана опубликовать или иным образом обеспечить неограниченный
      ...
      <Title level={3}>2.1 Принципы обработки персональных данных</Title>
      <Paragraph>
      ...
      <Paragraph>
        Для работы в StudWallet Пользователю необходимо пройти процедуру
        регистрации, в результате которой для Пользователя будет создана учетная
        запись.
      </Paragraph>
      <Title level={3}>2.2. Условия обработки персональных данных</Title>
      <Paragraph>
      ...
      <Title level={3}>2.3. Конфиденциальность персональных данных</Title>
      <Paragraph>
      ...
      <Title level={3}>2.4 Общедоступные источники персональных данных</Title>
      <Paragraph>
        ...
        сообщаемые субъектом персональных данных. Сведения о субъекте должны
        быть в любое время исключены из общедоступных источников персональных
        данных по требованию субъекта либо по решению суда или иных
        уполномоченных государственных органов.
      </Paragraph>
      <Title level={3}>2.5 Специальные категории персональных данных</Title>
      <Paragraph>
      ...
      <Title level={3}>2.7 Трансграничная передача персональных данных</Title>
      <Paragraph>
      ...
      <Paragraph>
        ...
        <ul>
          <li>
            ...
            трансграничную передачу его персональных
          </li>
          данных;
          <li>
      ...
      <Title level={2}>3. Права субъекта персональных данных</Title>
      <Title level={3}>
      ...
      <Title level={3}>3.2 Права субъекта персональных данных</Title>
      <Paragraph>
      ...
      <Title level={2}>4. Обеспечение безопасности персональных данных</Title>
      <Paragraph>
      ...
      <Title level={2}>5. Заключительные положения</Title>
      <Paragraph>
        ...
        персональных данных. Должностные лица Оператора, виновные в нарушении
        норм, регулирующих обработку и защиту персональных данных, несут
        материальную, дисциплинарную, административную, гражданско-правовую или
        уголовную ответственность в порядке, установленном федеральными
        законами.
      </Paragraph>
    </Modal>
  );
